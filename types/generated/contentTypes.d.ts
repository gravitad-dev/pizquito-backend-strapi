...
export interface ApiClassroomClassroom extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    classroomStatus: Schema.Attribute.Enumeration<
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    studentLimit: Schema.Attribute.Integer;
...
export interface ApiEnrollmentEnrollment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    school_period: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiInvoiceInvoice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    invoiceType: Schema.Attribute.Enumeration<
...
export interface ApiPromotionPromotion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    promotionType: Schema.Attribute.Enumeration<['one_time', 'monthly']>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSchoolPeriodSchoolPeriod
  extends Struct.CollectionTypeSchema {
  collectionName: 'school_periods';
  info: {
    displayName: 'School Period';
    pluralName: 'school-periods';
    singularName: 'school-period';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    serviceType: Schema.Attribute.Enumeration<
      ['student_service', 'employee_service', 'school_service', 'other']
    >;
    title: Schema.Attribute.String;
    uid: Schema.Attribute.UID;
    updatedAt: Schema.Attribute.DateTime;
